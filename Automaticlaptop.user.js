// ==UserScript==
// @name         🚀 SIÊU TOOL v9.1 - CHỮ BỰ DESKTOP
// @namespace    http://tampermonkey.net/
// @version      9.1.1
// @description  Giữ nguyên khung V9.1 nhưng tăng font chữ cực to cho Desktop View
...
(function() {
    ...
    function hienThiCommanderDoanhThu(tong, chiTiet) {
        ...
        // BẢN CSS MỚI: BỘ KHUNG GỐC + FONT CHỮ BỰ (MIN-HEIGHT NỚI NHẸ)
        const cssGoc = `
            * { box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif !important; -webkit-font-smoothing: antialiased; -moz-osx-font-smoothing: grayscale; }
            .th-container { padding: 5px; width: 100%; max-width: 1200px; margin: 10px auto; position:relative; }
            ...
            .group-card { background: #fff; border: 1px solid #e0e6ed; padding: 10px 8px; border-radius: 16px; border-bottom: none; display: flex; flex-direction: column; justify-content: space-between; min-height: 100px; box-shadow: 0 2px 6px rgba(0,0,0,0.05); width: 100%; flex: 1 1 48%;}
            .group-stats { display: flex; justify-content: space-between; align-items: center; width: 100%; margin-top: auto; }

            /* -- ĐOẠN TĂNG SIZE CHỮ NẰM Ở ĐÂY -- */
            #realtime-header { text-align: center; color: #fff; background: #004a99; padding: 8px 0; font-size: 20px; font-weight: 950; border-radius: 8px; margin-bottom: 8px; border: 2px solid #ffc107; }
            .stat-label { font-size: 15px; font-weight: 900; color: #666; text-transform: uppercase; margin-bottom: 6px; }
            .stat-val { font-size: 38px !important; font-weight: 950 !important; color: var(--primary); text-shadow: 0.5px 0.5px 0px #000, 0px 0px 0px #000; line-height: 1.1; }
            .group-name { font-size: 18px !important; font-weight: 950 !important; color: var(--black); border-bottom: 1px solid #f0f0f0; padding-bottom: 4px; margin-bottom: 6px; text-transform: uppercase; min-height: 2.6em; line-height: 1.2; display: flex; align-items: center; gap: 6px; word-break: break-word; }
            .group-sticker { font-size: 32px !important; display: inline-block; transform: translateY(-1px); }
            .group-num { font-size: 26px !important; font-weight: 950 !important; color: var(--primary); text-shadow: 0.3px 0.3px 0px var(--primary); }
            .group-pct { font-size: 24px !important; font-weight: 950 !important; padding: 4px 8px; border-radius: 8px; text-shadow: 0.3px 0.3px 0px rgba(0,0,0,0.2); }
            /* -- HẾT ĐOẠN TĂNG SIZE -- */
